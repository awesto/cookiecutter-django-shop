...
from {{ cookiecutter.app_name }}.models import Product, Commodity, SmartCard, SmartPhoneVariant, SmartPhoneModel
from {{ cookiecutter.app_name }}.models.i18n_polymorphic.smartphone import OperatingSystem
