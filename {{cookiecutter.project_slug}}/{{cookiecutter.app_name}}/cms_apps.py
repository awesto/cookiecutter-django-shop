...
class CatalogListApp(CatalogListCMSApp):
    def get_urls(self, page=None, language=None, **kwargs):
        if settings.SHOP_TUTORIAL in ['i18n_polymorphic', 'polymorphic']:
            return ['{{ cookiecutter.app_name }}.urls.polymorphic_products']
        elif settings.SHOP_TUTORIAL == 'i18n_commodity':
            return ['{{ cookiecutter.app_name }}.urls.i18n_products']
        else:
            return ['{{ cookiecutter.app_name }}.urls.simple_products']
